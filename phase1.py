...
eng2.speak("CPU usage : Good") if res1 else eng2.speak("CPU usage: High")
print("CPU usage : Good") if res1 else print("CPU usage: High")
time.sleep(1)
res2 = sysStat.check_connectivity()
eng2.speak("Network : Good") if res2 else eng2.speak("Network : Bad")
print("Network : Good") if res2 else print("Network : Bad")
time.sleep(1)
res3 = sysStat.check_disk_usage("/")
eng2.speak("Disk Storage : Good") if res3 else eng2.speak("Disk Storage : "
	+ "Out of space")
print("Disk Storage : Good") if res3 else print("Disk Storage : "
	+ "Out of space")
time.sleep(1)
res4 = sysStat.check_localhost()
eng2.speak("Localhost : Working") if res4 else eng2.speak("Localhost : Failed")
print("Localhost : Working") if res4 else print("Localhost : Failed")
time.sleep(1)
res5 = sysStat.check_memory()
eng2.speak("Memory: Available") if res5 else eng2.speak("Low Memory")
print("Memory: Available") if res5 else print("Low Memory")
